...
##########################################################
    ...
    echo
apt update
apt install -y tor git terminator python3 python3-pip  zlib1g-dev libxml2-dev libxslt1-dev snapd tilix vim fish 
...
clear
    echo
    echo -e "\e[40;38;5;82m [+] \e[30;48;5;82m Installing hackers-tool-kit  \e[0m"
    echo
...
echo 
echo -e "\e[40;38;5;82m [+] \e[30;48;5;82m  RUN ansible-playbook -e ansible_python_interpreter=/usr/bin/python3 -i hosts threatbox_playbook.yml  \e[0m"
echo 
cd ..
echo 
pause 
